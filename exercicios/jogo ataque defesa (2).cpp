...
int main() {
    ...
    while (jogarNovamente == 1) {
        ...
        cout << "Insira o nome do defensor: "<<endl;
        cin >> defnome;

        cout << "Insira o poder de ataque: "<<endl;
        cin >> ataque;

        cout << "Insira a vida do defensor: "<<endl;
        cin >> vida;

        cout << "Insira o poder de defesa: "<<endl;
        cin >> poder;

        do {
            cout << "O personagem tem escudo? Digite apenas 1 para sim ou 0 para nao: "<<endl;
            cin >> escudo;

            while (escudo != 1 && escudo != 0) {
                cout << "Valor inválido! Digite apenas 1 para sim ou 0 para nao: "<<endl;
                cin >> escudo;
            }
            ...
            cout << "Deseja continuar atacando? 1 para sim e 0 para nao: "<<endl;
            cin >> continuar;
        ...
        cout << "Deseja jogar novamente? 1 para sim e 0 para nao: "<< endl;
        cin >> jogarNovamente;
    }
